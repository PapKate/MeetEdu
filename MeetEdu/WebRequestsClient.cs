...
namespace MeetEdu
{
    ...
    public static class HttpResponceMessageExtensions
    {
        ...
        /// <summary>
        /// Returns a <see cref="WebRequestResult{byte[]}"/> pre-populated with the <see cref="HttpWebResponse"/> information
        /// read as stream
        /// </summary>
        /// <param name="serverResponse">The server response</param>
        /// <returns></returns>
    ...
    public static class RouteHelpers
    {
        ...
        /// <summary>
        /// The information for the query arguement that is related to a property
        /// </summary>
