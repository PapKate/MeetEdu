...
namespace MeetBase.Blazor
{
    ...
    public static class NavigationManagerExtensions
    {
        ...
        public static void NavigateTo(this NavigationManager navigationManager, string route, string? value = null, Dictionary<string, string>? queryParams = null)
        {
            if (!value.IsNullOrEmpty())
                route += $"/{value}";
        ...
        public static void NavigateTo(this NavigationManager navigationManager, string route, string? value = null, string? queryKey = null, string? queryValue = null)
        {
            if (!value.IsNullOrEmpty())
                route += $"/{value}";
